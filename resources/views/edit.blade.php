...
<body>
    ...
    <div style="display: flex; justify-content: center;">
        <div class="div">
            <form action="/updateTask/{{$id}}" method="POST">
                @csrf 
                <div style="display: flex;">
                    <input type="text" placeholder="Enter a task" name="task" value="{{$checkTask->task}}" class="form-control">
                    <button class="btn btn-primary" style="margin-left: 15px;">Update</button>
                </div>
            </form>
        </div>
    </div><br>
